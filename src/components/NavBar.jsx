        ...
        <div className='bg-slate-800 text-slate-50 p-5 flex flex-row text-xl font-normal'>
            ...
            <div className='basis-3/4 flex flex-row justify-end items-center'>
                <div className='hidden md:flex'>
                    <h1 className='me-6'><a href="#Courses">Data-Science</a></h1>
                    <h1 className='me-6'><a href="#Courses">Front-End</a></h1>
                    <h1 className='me-6'><a href="#Courses">Back-End</a></h1>
                    <h1 className='me-6'><a href="#Courses">Full-Stack</a></h1>
                    <h1 className='me-6'><a href="#Courses">React-Native</a></h1>
                </div>
